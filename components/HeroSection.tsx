...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden">
      ...
      >
        <div id="home" className="relative z-10 w-full h-full" ref={containerRef}>
          {/* Content container */}
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 min-h-screen max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 lg:gap-8 min-h-screen w-full">
              ...
              {/* Main content column */}
              <div className="lg:col-span-3 flex flex-col justify-center items-center text-center py-12 sm:py-20 w-full">
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  ...
                  <div className="overflow-hidden mb-4 w-full">
                    ...
                    >
                      ...
                      <motion.span
                        className="relative inline-block ml-2 sm:ml-4 z-10"
                        style={{ color: "#F2C331" }}
                        initial={{ y: 80 }}
                        animate={{ y: 0 }}
                        transition={{
                  ...
                  {/* Animated Subheading */}
                  <div className="h-12 sm:h-16 mb-6 overflow-hidden w-full">
                    <AnimatePresence mode="wait">
                      <motion.h2
                        ...
                        className="text-xl sm:text-2xl md:text-3xl font-medium bg-clip-text text-transparent px-4"
                        style={{
                  ...
                  {/* Description */}
                  <motion.p
                    className="max-w-2xl mx-auto text-base sm:text-lg leading-relaxed mb-8 sm:mb-10 font-medium px-4"
                    style={{ 
                      color: "#102734", 
                  ...
                  {/* CTA Buttons */}
                  <motion.div
                    className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 px-4 w-full"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <motion.a
                      href="#about"
                      className="px-6 sm:px-8 py-3 sm:py-4 text-white font-medium rounded-full flex items-center justify-center shadow-lg group relative overflow-hidden w-full sm:w-auto max-w-xs mx-auto sm:mx-0"
                      style={{ backgroundColor: "#37B4EC" }}
                    ...
                    <motion.a
                      href="#timeline"
                      className="px-6 sm:px-8 py-3 sm:py-4 bg-transparent font-medium rounded-full flex items-center justify-center relative overflow-hidden group w-full sm:w-auto max-w-xs mx-auto sm:mx-0"
                      style={{
