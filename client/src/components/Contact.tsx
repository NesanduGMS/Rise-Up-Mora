...
const ContactCard = memo(({ name, role, organization, email, phone, social, index, category }: ContactCardProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Image Section */}
        <div
          className="w-32 h-32 bg-gray-200 rounded-full overflow-hidden shadow-md mx-auto border-2"
          style={{
